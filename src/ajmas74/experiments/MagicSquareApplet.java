 ...
 *
 */
public class MagicSquareApplet extends Applet {
...
//      //g.drawRect(0,0,rect.width,rect.height);
  ...
  class MouseListenerImpl implements MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
      ...
      if ( _board._layout[y][x] != 0 ) {
        ...
        //repaint(0,0,240,240);
        //repaint(rect1);
        repaint(rect1.x,rect1.y,rect1.width,rect1.height);
  ...
  public void init() {
    ...
    try {
      String imageURLStr = getParameter("image.url");
      if ( imageURLStr == null ) {
        imageURLStr = "http://andrmas/applets/magicsquare/jordan001.jpg";
      } 
      
      _overlayImage = getImage(new URL(imageURLStr));
      _overlayImage.getHeight(new MyImageObserver());
      
      String colorStr = getParameter("color");
      _textColor = Color.BLACK;
      if ( colorStr != null && _colorMap.get(colorStr) != null) {
        //imageURLStr = "http://andrmas/applets/magicsquare/jordan001.jpg";
        _textColor = (Color) _colorMap.get(colorStr);
      }
