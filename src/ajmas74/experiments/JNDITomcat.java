...
public class JNDITomcat {
  ...
  public JNDITomcat() throws Exception {
    ...
    //	Look up our data source
		...
		//DataSource datasource = (DataSource) initialContext.lookup((String)settings.get(CONNECTION_POOL_NAME));
  ...
  private void exploreNext(int depth, DirContext ctx, String path)
    ...
    NamingEnumeration enum = ctx.list(path);
    ...
    while (enum.hasMore()) {
      ...
      if (ncp
        .getClassName()
        .equals("weblogic.jndi.internal.ServerNamingNode")) {
