...
public class WebTreeLi
{
    ...
    Map generateTestMap ()
    {
        ...
        rootMap.put( new Node("mc.gif","L1-1",false), map = new HashMap() );

        map.put( new Node("mc.gif","L2-1",false), map2 = new HashMap() );

        map2.put( new Node("mc.gif","L3-1",false), null );
        map2.put( new Node("mc.gif","L3-2",false), null );

        map.put( new Node("mc.gif","L2-2",false), map2 = new HashMap() );

        map2.put( new Node("mc.gif","L3-1",false), null );
        map2.put( new Node("mc.gif","L3-2",false), null );

        rootMap.put( new Node("mc.gif","L1-2",false), map = new HashMap() );
    ...
    private boolean hasOpenChild ( Map map )
    {
     ...
     * @return ...
     */
    public String generateTree ( Map map)
    {
     ...
     * @return ...
     */
    public String generateTree ( String name, int depth, Map map )
    {
        ...
        strBuf.append(genMultiSpaces(depth)+"<ul id=\""+name+"\">\n");
        ...
        while ( iter.hasNext() )
        {
            ...
            //strBuf.append("<td><table cellpadding='0'cellspacing='0'><tr><td><img src=\""+node.icon+"\"></td><td class='auto'>&nbsp;"+node.name+"</td></tr></table></td></tr>\n");
            strBuf.append(genMultiSpaces(depth)+"<li><table cellpadding='0'cellspacing='0'><tr><td id='"+tmpName+"_node' class=\""+cssClass+"\" "+expandableText+">"+controlText+"</td><td><img src=\""+node.icon+"\"></td><td class='auto'>&nbsp;"+node.name+"</td></tr></table>\n");
            ...
            if ( childMap != null)
            {
                ...
                //strBuf.append("<li>");
                strBuf.append(generateTree(subName,depth+1,childMap));
                
            }
            strBuf.append("</li>\n");
            i++;
        }
        strBuf.append(genMultiSpaces(depth)+"</ul>\n");
        return strBuf.toString();
    }
    
    StringBuffer strBuf = new StringBuffer();
    
    private String genMultiSpaces ( int count )
    {
        strBuf.setLength(0);
