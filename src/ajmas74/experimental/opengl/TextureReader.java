...
public class TextureReader {
    ...
    public static Texture readTexture(InputStream in) throws IOException {
        return readTexture(in, false);
    }
    
    public static Texture readTexture(InputStream in , boolean storeAlphaChannel)
        throws IOException {
        BufferedImage bufferedImage;

        bufferedImage = readImage(in);
    ...
    private static Texture readPixels(BufferedImage img,
        ...
        ByteBuffer unpackedPixels = BufferUtil
                .newByteBuffer(packedPixels.length * bytesPerPixel);
