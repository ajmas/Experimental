 ...
 * @param <T>
 */
public class SmallestElements<T extends Comparable<T>> extends MaxSizeList<T>  {

	int blockSize = 50;

	public SmallestElements(int maxSize) {
		super(maxSize, new ArrayList<T>());
	}
	...
	public static void main(String[] args)  {
		...
		for (int x=0; x<1000; x++) {
			SmallestElements<Integer> smallestIntegers = new SmallestElements<Integer>(100);
